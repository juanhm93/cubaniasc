...
export default function AdminPaymentStudentEnroll({
    courses,
}: EnrollPageProps) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        form.post(admin.payments.enroll.store.url(), {
            preserveScroll: true,
        });
    };
    ...
    return (
        <>
            <Head title={t('admin.payments.enrollStudentTitle')} />

            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <h1 className="text-2xl font-semibold">
                            {t('admin.payments.enrollStudentTitle')}
                        </h1>
                        <p className="text-sm text-muted-foreground">
                            {t('admin.payments.enrollStudentDescription')}
                        </p>
                    </div>
                ...
                >
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="stu-city">{t('common.city')}</Label>
                            <Input
                                id="stu-city"
                                name="city"
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="stu-emergency-name">
                                {t(
                                    'admin.preRegistrations.emergencyContactName',
                                )}
                            </Label>
                            <Input
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="stu-emergency-phone">
                                {t(
                                    'admin.preRegistrations.emergencyContactPhone',
                                )}
                            </Label>
                            <Input
                        ...
                        <div className="grid gap-2 sm:col-span-2">
                            <Label htmlFor="stu-course">
                                {t(
                                    'admin.preRegistrations.enrollInCourseOptional',
                                )}
                            </Label>
                            <select
                                id="stu-course"
...
AdminPaymentStudentEnroll.layout = {
    breadcrumbs: [
        {
        ...
        },
        {
            ...
            href: admin.payments.enroll.create.url(),
        },
    ],
};
